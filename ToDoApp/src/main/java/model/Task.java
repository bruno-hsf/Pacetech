...
public class Task {
    ...
    public Task(){
        //qdo criar um objeto que não for passado nenhum valor na chamada
        //essa linha serve para informar que a tarefa foi criada no momento em que o objeto foi instanciado
