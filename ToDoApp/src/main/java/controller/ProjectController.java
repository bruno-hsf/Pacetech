...
public class ProjectController {
    ...
    public void save(Project project)  {
        //Lembrando que não vou passar o Id neste método, pois é autoincremento
    ...
    public void update(Project project) {
        //Vou usar o Id como filtro da query "Update", por isso vou ter que setá-lo
    ...
    //Quero mostrar todos os prjetos, por enquanto. Logo não teremos o filtro igual fizemos na Classe TaskController
